  ...
  return (
      <div className="h-screen flex justify-center">
        ...
        <div className="flex w-1/2 justify-center items-center bg-white">
          <form className="bg-white" onSubmit={e => handelSubmit(e)}>
            ...
            <div className='mb-4'>
              <div className="flex items-center border-2 py-2 px-3 rounded-2xl">
                ...
                <input className="pl-2 outline-none border-none" type="text" name="userName" required id="userName" placeholder="User Name" />
              </div>
              <span className='text-xs' onClick={() => {navigator.clipboard.writeText("atuny0")}}>Test Username : <span className='hover:text-blue-700'>atuny0</span> </span>
            </div>
            ...
            <div>
              <div className="flex items-center border-2 py-2 px-3 rounded-2xl">
                ...
                <input className="pl-2 outline-none border-none" type="password" required name="password" id="password" placeholder="Password" />
              </div>
              <span className='text-xs' onClick={() => {navigator.clipboard.writeText("9uQFF1Lh")}}>Test Password : <span className='hover:text-blue-700'>9uQFF1Lh</span> </span>
            </div>
