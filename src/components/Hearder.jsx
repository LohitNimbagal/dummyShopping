...
function Hearder() {
  ...
  return (
    ...
    <nav className="fixed top-0 left-0 z-20 w-full border-b border-gray-200 bg-white py-2.5 px-6 sm:px-4">
      ...
      {/* <!-- Login Button --> */}
      <button type="button" className=" rounde mr-3 hidden border border-blue-700 py-1.5 px-6 text-center text-sm font-medium text-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-300 md:inline-block rounded-lg" onClick={() => navigate("/cart")}>Cart</button>
